// ═══════════════════════════════════════════════════════════════
//  ParkControl — ESP32 Access Point + Web Server + I2C Maestro
//
//  Arquitectura:
//    [STM32 #1 - Grupo A] ──┐
//                           ├── I2C ──► [ESP32 Maestro] ──► WiFi AP ──► Navegador
//    [STM32 #2 - Grupo B] ──┘
//
//  Protocolo I2C (mensaje de 3 bytes):
//    1er byte → STM32 que envía  ('1' = Grupo A, '2' = Grupo B)
//    2do byte → posición          ('0' a '3')
//    3er byte → estado            ('F' = Free/Libre, 'O' = Occupied/Ocupado)
//
//  Ejemplos:
//    "1F0" → STM32 #1, posición 0, Libre   → A-1 libre
//    "10O" → STM32 #1, posición 0, Ocupado → A-1 ocupado
//    "23O" → STM32 #2, posición 3, Ocupado → B-4 ocupado
// ═══════════════════════════════════════════════════════════════
